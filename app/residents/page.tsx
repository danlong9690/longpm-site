      ...
      <main className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-5xl font-semibold tracking-tight text-slate-950 sm:text-6xl">
            Find your next home and access resident tools.
          </h1>
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Browse available properties, submit applications, and share your
            resident experience.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-7">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="text-xl font-semibold text-slate-950">{property.name}</div>
                    <div className="mt-1 text-sm text-slate-500">{property.city}</div>
                  </div>
                  <Badge className="rounded-full">{property.status}</Badge>
                </div>
                <div className="mt-5 text-sm font-medium text-slate-900">{property.type}</div>
                <div className="mt-4 grid grid-cols-3 gap-3 text-sm text-slate-600">
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-400">Beds</div>
                    <div className="mt-1 font-medium text-slate-900">{property.beds}</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-400">Baths</div>
                    <div className="mt-1 font-medium text-slate-900">{property.baths}</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-400">Rate</div>
                    <div className="mt-1 font-medium text-slate-900">{property.rent}</div>
                  </div>
                </div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          <Card className="rounded-[2rem] border-slate-200 shadow-sm">
            <CardContent className="p-8">
              ...
              <div className="mt-6 grid gap-4">
                ...
                />
                <Button className="w-fit rounded-full px-6">Submit Review</Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-[2rem] border-slate-200 shadow-sm">
            <CardContent className="p-8">
              <h3 className="text-xl font-semibold text-slate-950">Resident tools</h3>
              <div className="mt-6 grid gap-4 text-sm leading-6 text-slate-600">
                <div className="rounded-2xl bg-slate-50 p-4">Available property search</div>
                <div className="rounded-2xl bg-slate-50 p-4">Online rental applications</div>
                <div className="rounded-2xl bg-slate-50 p-4">Resident review submission</div>
                <div className="rounded-2xl bg-slate-50 p-4">Future maintenance request portal</div>
                <div className="rounded-2xl bg-slate-50 p-4">Future resident login integration</div>
              </div>
            </CardContent>
          </Card>
        </div>
